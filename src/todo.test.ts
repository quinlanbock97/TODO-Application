...
beforeAll(() => {
    const id1: number = MyTodo.addItem("Test 1", "December 25, 2020 06:24:00", true);
    const id2: number = MyTodo.addItem("Test 2", "September 4, 2020 03:24:00", false);
    const id3: number = MyTodo.addItem("Test 3", "May 8 2020 03:24:00", false);
    const id4: number = MyTodo.addItem("Test 4", "July 17, 2020 18:24:00", false);
    const id5: number = MyTodo.addItem("Test 5", "November 12, 2020 12:24:00", true);
    const id6: number = MyTodo.addItem("Test 6", "June 1, 2020 09:24:00", false);
...
describe("removeItem function", () => {
    ...
    test("item is added then removed, then length is checked to be 0", () => {
        const id: number = MyTodo.addItem("Test 1", "June 1, 2020 09:24:00");
